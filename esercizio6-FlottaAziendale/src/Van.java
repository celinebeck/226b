public class Van extends Auto implements Vehicle {
    //attributi
    //costruttore


    public Van(String model, boolean statusMotion, boolean statusStationary, int km, Fuel fuel) {
    ...
    public String costFuel(){
        ...
        float fluelcost = super.getKm() * 2f;
